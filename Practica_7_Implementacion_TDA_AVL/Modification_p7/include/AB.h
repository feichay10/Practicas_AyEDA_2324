...
class AB {
 public:
  ...
  // Modification
  int getCountSearchesABB() {
    return countSearchesABB_;
  }

  int getCountSearchesABE() {
    return countSearchesABE_;
  }

  int getCountSearchesAVL() {
    return countSearchesAVL_;
  }
 ...
 protected:
  ...
  // Modification
  mutable int countSearchesABB_ = 0;
  mutable int countSearchesABE_ = 0;
  mutable int countSearchesAVL_ = 0;
};
